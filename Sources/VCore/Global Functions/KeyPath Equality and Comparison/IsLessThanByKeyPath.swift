...
public func isLess<T>(
    ...
    if lhs[keyPath: keyPath0] != rhs[keyPath: keyPath0] { lhs[keyPath: keyPath0] < rhs[keyPath: keyPath0] }
    else if lhs[keyPath: keyPath1] != rhs[keyPath: keyPath1] { lhs[keyPath: keyPath1] < rhs[keyPath: keyPath1] }
    else if lhs[keyPath: keyPath2] != rhs[keyPath: keyPath2] { lhs[keyPath: keyPath2] < rhs[keyPath: keyPath2] }
    else if lhs[keyPath: keyPath3] != rhs[keyPath: keyPath3] { lhs[keyPath: keyPath3] < rhs[keyPath: keyPath3] }
    else if lhs[keyPath: keyPath4] != rhs[keyPath: keyPath4] { lhs[keyPath: keyPath4] < rhs[keyPath: keyPath4] }
    else if lhs[keyPath: keyPath5] != rhs[keyPath: keyPath5] { lhs[keyPath: keyPath5] < rhs[keyPath: keyPath5] }
    else if lhs[keyPath: keyPath6] != rhs[keyPath: keyPath6] { lhs[keyPath: keyPath6] < rhs[keyPath: keyPath6] }
    else { false }
}
...
public func isLess<T>(
    ...
    else if lhs[keyPath: keyPath7] != rhs[keyPath: keyPath7] { lhs[keyPath: keyPath7] < rhs[keyPath: keyPath7] }
    else { false }
}
...
public func isLess<T>(
    ...
    else if lhs[keyPath: keyPath8] != rhs[keyPath: keyPath8] { lhs[keyPath: keyPath8] < rhs[keyPath: keyPath8] }
    else { false }
}
...
public func isLess<T>(
    ...
    else if lhs[keyPath: keyPath9] != rhs[keyPath: keyPath9] { lhs[keyPath: keyPath9] < rhs[keyPath: keyPath9] }
    else { false }
}
