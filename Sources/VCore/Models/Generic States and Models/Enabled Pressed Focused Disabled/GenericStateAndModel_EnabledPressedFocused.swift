...
public nonisolated enum GenericState_EnabledPressedFocused: Int, Sendable, CaseIterable {
    // MARK: Cases
    /// Enabled.
    case enabled
...
public nonisolated struct GenericStateModel_EnabledPressedFocused<Value> {
    // MARK: Properties
    /// Enabled value.
