...
public enum GenericState_DeselectedSelectedPressedDisabled: Int, CaseIterable {
    ...
    public var isEnabled: Bool {
        ...
        case .pressedDeselected: return true
        case .pressedSelected: return true
...
/// Color group containing `deselected`, `selected`, `pressed` (`deselected`), `pressed` (`selected`), and `disabled`.
///
