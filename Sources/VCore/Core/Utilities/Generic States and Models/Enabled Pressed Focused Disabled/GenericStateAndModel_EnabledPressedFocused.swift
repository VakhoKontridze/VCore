...
nonisolated public enum GenericState_EnabledPressedFocused: Int, Sendable, CaseIterable {
    // MARK: Cases
    /// Enabled.
    case enabled
...
nonisolated public struct GenericStateModel_EnabledPressedFocused<Value> {
    // MARK: Properties
    /// Enabled value.
...
nonisolated extension GenericStateModel_EnabledPressedFocused: Equatable where Value: Equatable {}

nonisolated extension GenericStateModel_EnabledPressedFocused: Hashable where Value: Hashable {}

nonisolated extension GenericStateModel_EnabledPressedFocused: Sendable where Value: Sendable {}

nonisolated extension GenericStateModel_EnabledPressedFocused {
    /// Maps state to model.
