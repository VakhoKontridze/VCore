...
nonisolated public enum GenericState_OffOnIndeterminatePressed: Int, Sendable, CaseIterable {
    // MARK: Cases
    /// Off.
    case off
...
nonisolated public struct GenericStateModel_OffOnIndeterminatePressed<Value> {
    // MARK: Properties
    /// Off value.
