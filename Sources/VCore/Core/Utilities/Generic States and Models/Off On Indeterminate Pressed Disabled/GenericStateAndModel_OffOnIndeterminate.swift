...
nonisolated public enum GenericState_OffOnIndeterminate: Int, Sendable, CaseIterable {
    // MARK: Cases
    /// Off.
    case off
...
nonisolated extension Binding<GenericState_OffOnIndeterminate> {
...
nonisolated public struct GenericStateModel_OffOnIndeterminate<Value> {
    // MARK: Properties
    /// Off value.
    ...
    ) rethrows -> GenericStateModel_OffOnIndeterminate<NewValue> {
        .init(
