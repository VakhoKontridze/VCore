...
nonisolated public enum GenericState_OffOnIndeterminatePressedDisabled: Int, Sendable, CaseIterable {
    // MARK: Cases
    /// Off.
    case off
...
nonisolated public struct GenericStateModel_OffOnIndeterminatePressedDisabled<Value> {
    // MARK: Properties
    /// Off value.
