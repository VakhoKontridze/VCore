...
nonisolated public enum GenericState_CollapsedExpandedDisabled: Int, Sendable, CaseIterable {
    // MARK: Cases
    /// Collapsed.
    case collapsed
...
nonisolated public struct GenericStateModel_CollapsedExpandedDisabled<Value> {
    // MARK: Properties
    /// Collapsed value.
