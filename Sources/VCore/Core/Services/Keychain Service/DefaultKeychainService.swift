...
nonisolated open class DefaultKeychainService: KeychainService, @unchecked Sendable {
    // MARK: Properties - Singleton
    /// Shared instance of `DefaultKeychainService` that uses `default` configuration.
    public static let shared: DefaultKeychainService = .init(
    ...
    // MARK: Initializers
    /// Initializes `DefaultKeychainService`.
    public init(
