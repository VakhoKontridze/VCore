...
nonisolated open class DefaultUserDefaultsService: UserDefaultsService, @unchecked Sendable {
    // MARK: Properties - Singleton
    /// Shared instance of `DefaultUserDefaultsService`.
    public static let shared: DefaultUserDefaultsService = .init(
    ...
    // MARK: Initializers
    /// Initializes `DefaultUserDefaultsService` with `UserDefaults`.
    public init(
