...
Members declared within a non-`final` `class` execute using a dynamic dispatch. Whole members declared in an extension execute using a static dispatch. If extra performance is required, this may seem as a viable option.
