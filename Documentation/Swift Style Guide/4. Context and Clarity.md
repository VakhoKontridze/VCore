...
`guard` statements should be used to check preconditions. For instance, `guard` statement used in previous section. If those conditions fail, logic cannot continue.
